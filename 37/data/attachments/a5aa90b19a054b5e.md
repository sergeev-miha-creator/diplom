...
- Name: ui.spec.js >> Регистрация >> Add comment
- Location: tests/ui.spec.js:62:9
...
Call log:
  - waiting for getByRole('textbox', { name: 'Write a comment...' })
        ...
        - list [ref=e10]:
          ...
          - listitem [ref=e17]:
            - generic [ref=e18] [cursor=pointer]:
              - img "Lester Hyatt-Little" [ref=e19]
              - text: Lester Hyatt-Little
            - text:   
  - main [ref=e20]:
    - group [ref=e26]:
      - text: Title already exists..
      - group [ref=e27]:
        - textbox "Article Title" [ref=e28]: tomography
      - group [ref=e29]:
        - textbox "What's this article about?" [ref=e30]: roundabout
      - group [ref=e31]:
        - textbox "Write your article (in markdown)" [ref=e32]: Clibanus aestivus voco coruscus assentator tutis toties accusator statim occaecati. Enim molestias administratio. Barba dolor cupio cultellus cotidie aut sum asper umbra adicio.
      - group [ref=e33]:
        - textbox "Enter tags" [ref=e34]: dependency
